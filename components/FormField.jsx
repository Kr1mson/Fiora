...
const FormField = ({title,value,placeholder,valid,
  ...
  return (
    <View className={`space-y-2 ${otherStyles} `}>
      ...
      <View className="border-2 border-black-200 w-full h-16 px-4 bg-primary
      rounded-2xl focus:border-secondary items-center flex-row">
        <TextInput className="flex-1 text-black-100 font-psemibold text-base"
        value={value}
